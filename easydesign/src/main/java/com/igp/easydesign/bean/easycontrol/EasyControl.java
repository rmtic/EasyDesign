...
public class EasyControl extends BaseEasyControl {
    ...
    public void drawLeftTopTips(@NonNull Canvas canvas) {
        ...
        canvas.drawText(String.format("角度 [%s °],设计宽高[W:%sdp,H%sdp] [%s px,%s px]",degree,width,height, ConvertUtils.dp2px(width),ConvertUtils.dp2px(height)),dstRect.left,dstRect.top - tipBoxTopDistance - tipBoxHeight / 4 ,paintTip);
        //绘制图片设计的信息
